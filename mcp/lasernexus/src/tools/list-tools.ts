...
export const MCP_TOOLS = [
  ...
  },
  {
    name: "doe_matrix",
    description:
      "Stage 3: DOE for power, speed, focus, gap, wire, gas, pulse, wobble, nozzle, cooling, and clamp axes.",
    inputSchema: {
      type: "object" as const,
      properties: {
        ...
        pulseFrequencyMin: { type: "number" },
        pulseFrequencyMax: { type: "number" },
        pulseWidthMin: { type: "number" },
        pulseWidthMax: { type: "number" },
        dutyCycleMin: { type: "number" },
        dutyCycleMax: { type: "number" },
        wobbleAmplitudeMin: { type: "number" },
        wobbleAmplitudeMax: { type: "number" },
        wobbleFrequencyMin: { type: "number" },
        wobbleFrequencyMax: { type: "number" },
        scanWidthMin: { type: "number" },
        scanWidthMax: { type: "number" },
        nozzleDistanceMin: { type: "number" },
        nozzleDistanceMax: { type: "number" },
        nozzleAngleMin: { type: "number" },
        nozzleAngleMax: { type: "number" },
        coolingWaterTempMin: { type: "number" },
        coolingWaterTempMax: { type: "number" },
        coolingFlowMin: { type: "number" },
        coolingFlowMax: { type: "number" },
        coolingPressureMin: { type: "number" },
        coolingPressureMax: { type: "number" },
      },
